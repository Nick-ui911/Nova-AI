        ...
        {isLoading ? (
          ...
          <div className="h-full flex items-center justify-center px-4">
            <div className="text-center space-y-3 sm:space-y-4">
              ...
              <p className="text-base sm:text-lg font-medium bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent">
          ...
          <>
            {messages.map((m, index) => (
              ...
              >
                <div className="flex items-start space-x-2 sm:space-x-3 max-w-[85%] sm:max-w-2xl md:max-w-3xl">
                  {m.role !== "user" && (
                  ...
                  <div
                    className={`px-3 py-2.5 sm:px-4 sm:py-3 md:px-5 md:py-3.5 rounded-xl sm:rounded-2xl shadow-lg backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:scale-[1.02] ${
                      m.role === "user"
