          ...
          <div className="p-8 md:p-12 flex flex-col justify-center">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full border-2 border-gray-300 rounded-lg py-3 hover:bg-gray-50 transition flex items-center justify-center gap-3 font-medium text-gray-700 hover:border-orange-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {googleLoading ? (
                  <>
